...
/**
 * Resource Server configuration for protecting API endpoints. Validates JWT
 * tokens and enforces authorization rules.
 */
@Configuration
@EnableWebSecurity
...
public class ResourceServerConfig {
	...
	public SecurityFilterChain resourceServerSecurityFilterChain(HttpSecurity http) throws Exception {
		http.securityMatcher("/api/**", "/customers/**", "/bookings/**", "/feedback/**", "/tables/**",
				"/opening-hours/**", "/orders/**", "/healthcheck/**").authorizeHttpRequests(
						authorize -> authorize
								// Public endpoints
								...
								.hasAnyAuthority("SCOPE_backend.read", "ROLE_USER", "ROLE_OPERATOR", "ROLE_ADMIN")
								.requestMatchers(HttpMethod.GET, "/bookings/**")
								.hasAnyAuthority("SCOPE_backend.read", "ROLE_USER", "ROLE_OPERATOR", "ROLE_ADMIN")
								.requestMatchers(HttpMethod.GET, "/feedback/**")
								.hasAnyAuthority("SCOPE_backend.read", "ROLE_USER", "ROLE_OPERATOR", "ROLE_ADMIN")
								.requestMatchers(HttpMethod.GET, "/tables/**")
								.hasAnyAuthority("SCOPE_backend.read", "ROLE_USER", "ROLE_OPERATOR", "ROLE_ADMIN")
								.requestMatchers(HttpMethod.GET, "/opening-hours/**")
								.hasAnyAuthority("SCOPE_backend.read", "ROLE_USER", "ROLE_OPERATOR", "ROLE_ADMIN")
								...
								.hasAnyAuthority("SCOPE_backend.write", "ROLE_OPERATOR", "ROLE_ADMIN")
