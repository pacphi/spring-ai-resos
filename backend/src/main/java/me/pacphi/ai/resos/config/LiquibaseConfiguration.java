...
/**
 * Configuration class that ensures proper ordering between SchemaCreator and
 * Liquibase.
 * <p>
 * The critical requirement is that SchemaCreator must complete
 * its @PostConstruct (which generates changelogs) BEFORE SpringLiquibase
 * initializes (which reads them).
 * <p>
 * This is achieved by:
 * <ol>
 * <li>Using BeanFactoryPostProcessor to add @DependsOn to SpringLiquibase bean
 * definition</li>
 * <li>SpringLiquibase will wait for SchemaCreator to fully initialize
 * first</li>
...
public class LiquibaseConfiguration {
	...
	/**
	 * BeanFactoryPostProcessor that ensures SpringLiquibase depends on
	 * SchemaCreator.
	 * <p>
	...
	static BeanFactoryPostProcessor liquibaseDependencyEnforcer() {
		return new BeanFactoryPostProcessor() {
			...
			public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
				...
				String[] liquibaseBeanNames = beanFactory
						.getBeanNamesForType(liquibase.integration.spring.SpringLiquibase.class, true, false);
