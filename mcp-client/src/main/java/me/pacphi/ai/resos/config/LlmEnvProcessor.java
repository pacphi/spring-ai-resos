...
public class LlmEnvProcessor implements CfEnvProcessor {
	...
	private static void addOrUpdatePropertyValue(String propertyName, String credentialName,
			CfCredentials cfCredentials, Map<String, Object> properties) {
	...
	public boolean accept(CfService service) {
		return service.getName().equalsIgnoreCase(SERVICE_NAME);
	}

	@Override
	public CfEnvProcessorProperties getProperties() {
		return CfEnvProcessorProperties.builder().serviceName(SERVICE_NAME).build();
	}
	...
	public void process(CfCredentials cfCredentials, Map<String, Object> properties) {
		...
		addOrUpdatePropertyValue("spring.ai.openai.embedding.options.model", "EMBEDDING_MODEL", cfCredentials,
				properties);
	}
}
