...
/**
 * Authentication controller for the React SPA. Provides endpoints to check auth
 * status and get current user info. WebMVC-based (servlet stack)
 * implementation.
 */
@RestController
...
public class AuthController {
	...
	/**
	 * Check authentication status. Returns whether the user is authenticated
	...
	public Map<String, Object> getAuthStatus() {
		...
		return Map.of("authenticated", false, "loginUrl", "/oauth2/authorization/frontend-app");
	}
