 ...
 * spring.ai.mcp.client.initialized=false and manually initialize clients on
 * first use when OAuth2 context is available.
 * </p>
 */
@Component
public class McpSyncClientManager {
	...
	/**
	 * Get MCP sync clients, initializing them on first access. This ensures OAuth2
	 * tokens are available when initialization occurs.
	 */
