...
/**
 * Cookie-based implementation of AuthorizationRequestRepository. Stores OAuth2
 * authorization requests in encrypted cookies instead of HTTP session. This
 * avoids session-related issues in OAuth2 flows across different origins.
 */
