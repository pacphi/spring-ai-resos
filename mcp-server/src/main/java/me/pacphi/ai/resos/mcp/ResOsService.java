...
public class ResOsService {
	...
	public OpeningHours getOpeningHoursById(
			@ToolParam(description = "A unique identifier used to return a specific restaurant and day opening hours record") String id) {
	...
	public Customer getCustomerById(
			@ToolParam(description = "A unique identifier used to return a specific customer record") String id) {
	...
	public Feedback getFeedbackById(
			@ToolParam(description = "A unique identifier used to return a specific feedback record") String id) {
